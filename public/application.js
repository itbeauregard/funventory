...
var onCreateAccount = function onCreateAccount(event) {
  ...
  if (data.credentials.password !== data.credentials.password_confirmation) {
    $(function () {
      return $('#password-match-error').show();
    });
  } else {
...
var onCreateProduct = function onCreateProduct(event) {
  ...
  productApi.createProduct(data).then(productUi.onCreateProductSuccess).catch(productUi.onCreateProductError);
};
...
var onGetAllProducts = function onGetAllProducts(event) {
  ...
  event.preventDefault();
  var data = getFormFields(event.target);
  productApi.getAllProducts(data).then(productUi.onGetAllProductsSuccess).catch(productUi.onGetAllProductsError);
};

var onGetProduct = function onGetProduct(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  productApi.getProduct(data).then(productUi.onGetProductSuccess).catch(productUi.onGetProductError);
};
...
var onUpdateProduct = function onUpdateProduct(event) {
  ...
  console.log(data);
  console.log(id);
  productApi.updateProduct(data, id).then(productUi.onUpdateProductSuccess).catch(productUi.onUpdateProductError);
};
...
var onDeleteProductError = function onDeleteProductError(error) {
  console.error(error);
};
...
var onGetProductError = function onGetProductError(error) {
  console.error(error);
};
